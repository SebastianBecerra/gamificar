...
public class EFE_Base: MonoBehaviour {
    ...
    private int num1Conv;
    private int num2Conv;
    private int total;
	...
	void Start () {
        ...
        error1 = GameObject.FindGameObjectsWithTag("error");
    ...
    public void OpenOverlayPanel2(GameObject panel)
    {
        //set this to false for overlays
        //panelIsTransitioning=false;
        ...
        currentOverlay.transform.SetAsLastSibling();
            ...
            error1[0].SetActive(false);
            error1[1].SetActive(false);
        
    }


    public void OpenOverlayPanel3(GameObject panel)
    {
        string numero;
        string numero2;
        string errorPanel;
        errorPanel = "Popup_Mal";
        num1 = GameObject.FindGameObjectWithTag("input1");
        num2 = GameObject.FindGameObjectWithTag("input2");
        numero= num1.GetComponent<InputField>().text;
        numero2 = num2.GetComponent<InputField>().text;

        Compare(int.Parse(numero), int.Parse(numero2), total, panel, errorPanel);
    
    }

    void Compare(int num1Conv, int num2Conv, int total, GameObject panel, string errorPanel)
    {

        if (total == num1Conv + num2Conv)
        {
            string panelName = panel.name;
            currentOverlay = FindPanel(panelName);
            //print("Current overlay name "+currentOverlay.name);
	...
	public void ReloadCurrentScene()
	{
        ...
        //SceneManager.LoadScene("Menu - Matematica");

        //SceneManager.UnloadScene("Roll-a-ball");
	}
